...
#ifdef T7
    // Test 7: Servo motor with PWM and external power source
    // No GPIOs are set. They will be handled by the init_pwm function
#endif
...
int main()
{
    ...
    while (true) {
        ...
        int levels[] = {0, 625, 1250, 1875}; // 0%, 5%, 10%, 15%
        const char *percentages[] = {"0%", "5%", "10%", "15%"};
        ...
        int levels[] = {0, 5000, 6250, 7500}; // 0%, 40%, 50%, 60%
        const char *percentages[] = {"0%", "40%", "50%", "60%"};
