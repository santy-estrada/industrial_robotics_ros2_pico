...
static const float q0 = 0.8206f;//Pololu 0.2500f;   // PID coefficient
static const float q1 = -0.6716f;//Pololu -0.2167f;  // PID coefficient
static const float q2 = 0.00018646f;//Pololu 0.000058312f; // PID coefficient
